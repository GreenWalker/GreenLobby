package com.gmail.gustgamer29.configuration;
...
public class ConfigHandler extends YamlConfiguration {
    ...
    public String getStringReplacedWithPrefix(String path){
        return this.getString(path).replaceAll("&", "§").replace("%prefix%", EmpireLobby.getInstance().getPluginPrefix());
    }
    ...
    public List<String> getReplacedStringList(String path){
        List<String> strings = new LinkedList<>();
        super.getStringList(path).forEach(s -> {
